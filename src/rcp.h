...
class RcpService {
 ...
 public:
  ...
  std::unique_ptr<class MapArrow> map_arrow;          // The /rcpmaparrow map player-arrow size (MapViewMap::Draw operand redirects).
  ...
  std::unique_ptr<class CopyLayoutChat> copy_layout_chat; // Copy Layout also copies chat windows/filters/names ([ChatManager] merge).
