...
enum CameraView {
  ...
  RcpCam = 2,       // Replaces ThirdPerson2 when enabled.
...
struct SPELL {
  ...
  short CalculateAffectChange(Rcp::GameStructures::GAMECHARINFO *char_info, BYTE caster_level, BYTE effect_index,
                              Rcp::GameStructures::_GAMEBUFFINFO *buff = nullptr) {
    if (!char_info) return 0;
  ...
  bool IsBardSong() {
    return ClassLevel[Rcp::GameEnums::ClassTypes::Bard] != 0 && ClassLevel[Rcp::GameEnums::ClassTypes::Bard] != 0xff;
  }
  ...
  bool IsInstrumentModdableSpellEffect(BYTE effect) {
    ...
    switch (effect) {
      ...
      case 15:  // SE_CurrentMana
      {
        ...
        if (DurationType == 0 && TargetType != Rcp::GameEnums::SpellTargetType::Tap &&
            TargetType != Rcp::GameEnums::SpellTargetType::TargetedAETap && SpellType == 0)
          return true;
        return false;
      }
    }
